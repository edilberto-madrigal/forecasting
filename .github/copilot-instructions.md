...
df: ['fecha', 'producto_id', 'nombre', 'categoria', 'subcategoria',
       ...
       'ingresos', 'Amazon', 'Decathlon', 'Deporvillage', 'año', 'dia_semana',
       'mes', 'dia_mes', 'es_fin_semana', 'unidades_L1', 'unidades_L2', 'MM7',
       'es_festivo', 'es_black_friday', 'nombre_h_Adidas Own The Run Jacket',
...
df_inferencia: ['fecha', 'producto_id', 'nombre', 'categoria', 'subcategoria',
       ...
       'dia_semana', 'dia_mes', 'es_fin_semana', 'es_festivo',
       'es_black_friday', 'nombre_h_Adidas Own The Run Jacket',
       'nombre_h_Adidas Ultraboost 23', 'nombre_h_Asics Gel Nimbus 25',
       'nombre_h_Bowflex SelectTech 552', 'nombre_h_Columbia Silver Ridge',
       'nombre_h_Decathlon Bandas Elásticas Set', 'nombre_h_Domyos BM900',
       'nombre_h_Domyos Kit Mancuernas 20kg',
